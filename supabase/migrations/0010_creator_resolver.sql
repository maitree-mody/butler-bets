-- ============================================================
-- Migration: 0010_creator_resolver.sql
-- Allow the market creator (not just admins) to resolve their
-- own market.  All payout + notification logic is unchanged.
-- ============================================================
