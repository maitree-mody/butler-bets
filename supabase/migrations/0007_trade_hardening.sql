-- ============================================================
-- Migration: 0007_trade_hardening.sql
-- Adds an upper-bound share-count check to execute_trade.
-- Defence-in-depth: the server action (executeTradeAction) also
-- enforces this limit at the application layer.
-- ============================================================
